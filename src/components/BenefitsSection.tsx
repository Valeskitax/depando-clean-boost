...
const BenefitsSection = () => {
  ...
  return (
    <div className="py-20 bg-depando-accent">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-depando-primary mb-4">
            Beneficios de unirte a Depando
          </h2>
          <p className="text-lg md:text-xl text-depando-text max-w-2xl mx-auto">
            Ofrecemos excelentes condiciones para profesionales de limpieza que quieran formar parte de nuestro equipo.
          </p>
        </div>
        
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, index) => (
            <Card key={index} className="border-depando-primary/20 bg-depando-secondary">
